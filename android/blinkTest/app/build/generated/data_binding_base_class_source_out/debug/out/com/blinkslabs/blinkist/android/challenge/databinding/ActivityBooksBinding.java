...
public final class ActivityBooksBinding implements ViewBinding {
  ...
  private ActivityBooksBinding(@NonNull SwipeRefreshLayout rootView,
      @NonNull RecyclerView recyclerView, @NonNull SwipeRefreshLayout swipeRefreshView) {
  ...
  public static ActivityBooksBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      SwipeRefreshLayout swipeRefreshView = (SwipeRefreshLayout) rootView;

      return new ActivityBooksBinding((SwipeRefreshLayout) rootView, recyclerView,
          swipeRefreshView);
    }
